{
    ...
    const createCard = (data) => {
        ...
        if (playerProgresInput.dataset.idTracker === data.id) {
    ...
    const init = () => {
        const catalogAddBtn = createcatalogAddBtn();
        ...
        playerProgresInput.addEventListener('input', () => {
